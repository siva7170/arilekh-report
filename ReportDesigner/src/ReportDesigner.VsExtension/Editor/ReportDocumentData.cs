        ...
        IPersist
    {
        ...
        public int GetGuidEditorType(out Guid pClassID)
        {
            pClassID = _fileType == FileType.Rdx
                ? ReportDesigner.VsExtension.PkgGUID.RdxEditorFactory
                : ReportDesigner.VsExtension.PkgGUID.RdsEditorFactory;
        ...
        {
            pClassID = ReportDesigner.VsExtension.PkgGUID.RdxEditorFactory;
            return VSConstants.S_OK;
        }
    }
}
