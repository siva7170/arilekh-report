...
namespace ArilekhReport.WebApi.Services;
...
public sealed class ReportSessionService : IDisposable
{
            ...
            CancellationToken ct = default)
    {
        ...
        var report  = XmlReportSerializer.DeserializeReport(reportXml);
    ...
    private void Evict(object? state)
    {
        ...
        if (expired.Count > 0)
            _logger.LogInformation("Evicted {Count} expired report sessions.", expired.Count);
    }
